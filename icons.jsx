// Icon library — minimal line icons inline
const Icon = ({ name, size = 20, stroke = 1.7 }) => {
  ...
  switch (name) {
    ...
    case 'link':
      return <svg {...props}><path d="M10 13a5 5 0 0 0 7.5.5l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.5-.5l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>;
    case 'phone':
      return <svg {...props}><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12" y2="18.01"/></svg>;
    case 'truck':
